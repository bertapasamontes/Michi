...
var users_js_1 = require("../../src/app/model/users.js");
...
var getOneUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        ...
        users_js_1.default
            ...
            .catch(function (error) { return res.json({ mensaje: error }); });
        return [2 /*return*/];
    });
}); };
...
var postUser = function (req, res) {
    var user = new users_js_1.default(req.body);
    user
        .save()
        .then(function (data) { return res.json(data); })
        .catch(function (error) { return res.json({
...
var updateUser = function (req, res) {
    var id = req.params.id;
    var _a = req.body, name = _a.name, username = _a.username, surname = _a.surname, email = _a.email;
    users_js_1.default
        .updateOne({ _id: id }, { $set: { name: name, username: username, surname: surname, email: email } }) // con $set mongoDB actualiza el objeto de ese ID con el los datos del objeto que se le pasa (email, surname..).
        .then(function (data) { return res.json(data); })
        .catch(function (error) { return res.json({
        mensaje: error
    }); });
...
module.exports = {
    ...
    deleteOneUser: exports.deleteOneUser,
